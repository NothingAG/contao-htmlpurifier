 ...
 * @version    $Id: HTMLPurifierHelper.php 95 2012-02-15 15:45:28Z Red $
 */
...
//			$varValue = html_entity_decode($varValue, ENT_COMPAT, $GLOBALS['TL_CONFIG']['characterSet']);
	...
	private function getConfig()
	{
		...
		$arrTags = array_diff($arrTags, array('area', 'base', 'button', 'form', 'fieldset', 'input', 'label', 'legend', 'link', 'map', 'object', 'optgroup', 'option', 'param', 'select', 'style', 'textarea', 'u', 'script', 'fb', 'php'));
